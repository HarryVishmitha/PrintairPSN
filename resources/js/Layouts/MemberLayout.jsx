...
export default function MemberLayout({ header, title, children }) {
    const { url } = usePage();
        ...
        <BaseLayout title={title}>
            <div className="flex h-[calc(100vh-4rem)]">
                ...
                >
                    ...
                    {/* Quick Info (when sidebar is open) */}
                    {sidebarOpen && (
                        <div className="absolute bottom-4 left-4 right-4">
                            <div className="p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg">
                                ...
                                <div className="space-y-2 text-sm">
                                    ...
                                    <div className="flex justify-between">
                                        <span className="text-gray-600 dark:text-gray-400">My Assets</span>
                                        <span className="font-semibold text-gray-900 dark:text-white">15</span>
                                    </div>
                                </div>
                                <Link
                                    href="/member/orders/new"
                                    className="mt-3 flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors"
                                >
                                    New Order
                                </Link>
                            </div>
